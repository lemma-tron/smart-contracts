...
abstract contract LemaVotersV2 {
    ...
    function delegateMoreValidator(address validator) public {
        require(
            delagatedValidator[msg.sender],
            "LemaGovernance: Delegate one validator first"
        );
        if (votedToValidator[msg.sender][1] == address(0)) {
            ...
            revert("LemaGovernance: You have already delegated 3 validators");
        }
    }
    ...
    function changeValidatorOrder(
        ...
        require(
            ...
            "LemaGovernance: Second validator index out of bounds"
        );
