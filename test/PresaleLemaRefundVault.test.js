...
contract("PresaleLemaRefundVault", function (accounts) {
  it("should assert true", async () => {
    ...
    return assert(
      presaleLemaRefundVaultInstance !== undefined,
      "PresaleLemaRefundVault contract should be defined"
    );
  });

  it("should be 0", async () => {
    const totalBUSDDeposited =
      await presaleLemaRefundVaultInstance.totalBUSDDeposited();
